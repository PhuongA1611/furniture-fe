...
const Checkout = () => {
  ...
  useEffect(() => {
    if (userId) {
      setCartData(cart);
      try {
        dispatch(getListShipping(userId))
          .unwrap()
          .then((data) => setListShipping(data.data));
      } catch (error) {
        console.log(error);
      }
    } else {
                    ...
                    <Table>
                        ...
                        {cartData.cartItems.map((item, index) => (
                          <tr key={index}>
                            <td>
                              ...
                              <strong className="checkout__order__quantity">x {item.quantity}</strong>
                            </td>
                            <td>
                      ...
                      <tfoot>
                        ...
                        <tr>
                          <td>Total</td>
                          <td>
                            <span className="order-total">${cartData.totalAmount}</span>
                          </td>
                        </tr>
                      </tfoot>
                    </Table>
              ...
              <div className="checkout__shipping">
                ...
                {listShipping &&
                  ...
                  listShipping.map((item, index) => (
                    <div className="checkout__shipping__item" key={index}>
