...
const Category = () => {
  ...
  useEffect(() => {
    ...
    if (searchKey) {
      ...
      if (category) {
        if (listCate) {
          const categoryId = listCate.find((item) => item.categorySlug === category).id;
        ...
        <Row className="reverse">
          <Col lg={9}>
              ...
              <div className="category__select__sort">
                ...
                >
                  <ul className="dropdown-sort">
                    <li>
                      <a onClick={() => handleSelect()}>Default sorting</a>
                    </li>
                    {filter &&
            ...
            <div className="category__content">
              {listProduct && listProduct.map((item) => <ProductCard key={item.id} item={item} />)}
            </div>
          ...
          <Col lg={3}>
            ...
            <div className="category__list">
              ...
              {listProduct && listProduct.slice(0, 3).map((item, index) => <ProductRow key={index} item={item} />)}
            </div>
          </Col>
        </Row>
      </Container>
