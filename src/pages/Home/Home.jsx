...
import { Advertise, Banner, ListCategory, NoteCard, TabProducts } from '../../components';
import './Home.scss';
  ...
  useEffect(() => {
    try {
      dispatch(getListBanner())
        .unwrap()
        .then((data) => setListBanner(data.topSlider));
      dispatch(getListBanner())
        .unwrap()
        .then((data) => setListAdver(data.bottomSlider));
      ...
      dispatch(getListProducts(paramsArrival))
        .unwrap()
        .then((data) => setListArrival(data.products));
      ...
      dispatch(getListProducts(paramsSale))
        .unwrap()
        .then((data) => setListSale(data.products));
    } catch (error) {
      console.log(error);
    }
  }, []);
