    ...
    <section className="about">
      <Container>
        <div className="about__logo">
          <h2>
            The furture of <span>N</span>ordic
          </h2>
              ...
              <div className="about__element__wrapper about__pl">
                ...
                <div className="about__element__content">
                  <p>
                    ...
                    enim. Sed cursus turpis vitae tortor. Vestibulum ante ipsum primis in faucibus orci luctus et
                    ultrices posuere cubilia Curae; Fusce id purus.In consectetuer turpis ut velit. Suspendisse feugiat.
                    Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Fusce neque. Nam commodo suscipit
                    quam.
                  </p>
                  <p>
                    Suspendisse feugiat. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Fusce neque.
