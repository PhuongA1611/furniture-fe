...
import { Detail3D, ProductSlider } from '../../components';
import './Detail.scss';
...
const Detail = () => {
  ...
  const addToCart = (newData) => {
    ...
    if (isLogined) {
      const checkCart = listCart.find(
        (item) => item.productId === detail.id && item.size === newData.size && item.color === newData.color,
      );
      ...
      if (checkCart) {
        ...
        const params = {
          ...
          subTotal:
            ...
            (checkCart.discountPrice == 0 ? checkCart.sellingPrice : checkCart.discountPrice),
        };
      ...
      {detail && (
        <div className="detail">
              ...
              <Row>
                <Col lg={7}>
                  <div className="detail__wrapper">
                    <Detail3D product3D={detail.product3DModelPath} />
                ...
                <Col lg={5}>
                  <div className="detail__content">
                    <form>
                      ...
                      <div className="detail__content__selection">
                        ...
                        <div className="selection-wrapper">
                          {detail.productSize &&
                            detail.productSize.split(',').map((value, index) => (
                      ...
                      <div className="detail__content__selection">
                        ...
                        <div className="selection-wrapper">
                          {detail.productColor &&
                            detail.productColor.split(',').map((value, index) => (
                              <label htmlFor={value} key={index}>
                    ...
                    <div className="detail__content__btn">
                      <button type="submit" className="add-cart" onClick={handleAddToCart}>
                        Add to cart
                      </button>
                      <button type="submit" className="buy-now" onClick={handleBuy}>
                        buy now
                      </button>
                    </div>
          ...
          <div className="detail__desc">
            <Tabs defaultActiveKey="description" className="detail__desc__tabs">
