...
const Breadcrumb = () => {
  ...
  const crumbs = location.pathname.split('/').filter((crumb) => crumb !== '' && crumb !== 'product-category');
  ...
  return (
    <>
      {!accountCrumb && crumbs.length !== 0 && (
        <div
          className={id ? 'breadcrumb-detail' : 'breadcrumb-main'}
          style={id ? {} : { backgroundImage: `url(${bg})` }}
        >
          <Container>
