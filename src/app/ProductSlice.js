...
export const createProduct = createAsyncThunk(
  ...
  async (params) => await productApi.createProduct(params),
);

export const getDetail = createAsyncThunk(
  'product/getDetail',
  async (id, params) => await productApi.getDetail(id, params),
);

export const getListProducts = createAsyncThunk(
  'product/getListProducts',
  async (params) => await productApi.getListProducts(params),
);

export const updateProduct = createAsyncThunk(
  'product/updateProduct',
  async (id, params) => await productApi.updateProduct(id, params),
);

export const deleteProduct = createAsyncThunk(
  'category/deleteProduct',
  async (id) => await productApi.deleteProduct(id),
);
