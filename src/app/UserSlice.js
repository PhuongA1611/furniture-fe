...
export const updateUser = createAsyncThunk(
  'user/updateUser',
  async ({ userId, params }) => await userApi.updateUser({ userId, params }),
);

export const getListShipping = createAsyncThunk(
  'user/getListShipping',
  async (userId) => await userApi.getShipping(userId),
);

export const createShipping = createAsyncThunk(
  'user/createShipping',
  async ({ userId, params }) => await userApi.createShipping({ userId, params }),
);

export const updateShipping = createAsyncThunk(
  'user/updateShipping',
  async ({ id, params }) => await userApi.updateShipping({ id, params }),
);
